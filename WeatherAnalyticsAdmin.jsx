      ...
      <div className="g2">
        ...
        <div>
          <div className="card" style={{ marginBottom:12 }}>
            <div className="sT" style={{ marginBottom:12 }}>STORM ALERTS</div>
          ...
          <div className="card">
            <div className="sT" style={{ marginBottom:12 }}>TURBULENCE FORECAST</div>
        ...
        <div>
          ...
          <div className="card">
            ...
            <div style={{ marginTop:14, paddingTop:12, borderTop:'1px solid var(--bdr)' }}>
              <div className="sT" style={{ marginBottom:8, fontSize:9 }}>FLIGHT STATUS OVERRIDE</div>
