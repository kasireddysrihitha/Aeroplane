...
export default function Flights() {
  ...
  return (
    <div className="pg pgIn on" style={{ flex: 1, overflowY: 'auto', padding: 18, display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div className="pgDesc">Detailed list of every flight and its info.</div>

      {/* Filter buttons */}
      <div className="sDesc" style={{ marginBottom: -2 }}>Filter flights by boarding, delayed, conflict, etc.</div>
      ...
      {/* Summary cards */}
      <div className="sDesc" style={{ marginTop: 2, marginBottom: -2 }}>Quick totals for all, delayed, and boarding flights.</div>
      <div className="g3">
        {[
